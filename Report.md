...
| Optimization Tasks | Person(s)| File name | lines |
| - | - |  - | - |
...
| Code Generation Tasks | Person(s)| File name | lines |
| - | - |  - | - |
...
**Bindings** (optional)                           | Florian Favre, Guilherme Marques | src/main/scala/emitter/Emitter.scala | 17, 24, 54-59, 73-75, 107-121 |
